  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-100 to-blue-200">
      <div className="flex w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <form onSubmit={handleSubmit}>
            <div className="border border-[#F0F0F0] rounded-lg p-4 bg-[#F0F0F0] ">
              ...
              <div className="mb-2">
                ...
                <div className="relative">
                  <MdLockOutline className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={18} />
                  <input
                    type="password"
                    id="password"
                    name="password"
        ...
        {/* Right side */}
        <div className="hidden md:block w-1/2 bg-[#3587CA] rounded-tr-3xl rounded-br-3xl relative">
          <Image
